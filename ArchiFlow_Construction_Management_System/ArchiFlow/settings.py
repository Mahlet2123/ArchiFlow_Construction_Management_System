...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'archiflowcms@gmail.com'
EMAIL_HOST_PASSWORD = 'affn zybu jtus aykt'
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, 'templates'), os.path.join(BASE_DIR, 'cms', 'templates', 'account')],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
#client id ->> 593379816559-6chfarnji939m9aeglqkiijvphrg03nv.apps.googleusercontent.com
#client secret ->> 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
...
"""
SOCIALACCOUNT_PROVIDERS = {
    "google": {"APP": {"client_id": "593379816559-6chfarnji939m9aeglqkiijvphrg03nv.apps.googleusercontent.com", "secret": "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", "key": ""}}
}